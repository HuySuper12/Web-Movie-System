    ...
    public partial class AddIdentityAuthentication : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__MovieGen__0385055E5CB3ED1D", x => x.GenreID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Subscrip__755C22D789D64755", x => x.PlanID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Logs__5E5499A84C461684", x => x.LogID);
                    table.ForeignKey(
                        name: "FK_Logs_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Movies__4BD2943AF6A04ED5", x => x.MovieID);
                    table.ForeignKey(
                        name: "FK_Movies_UploadedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Notifica__20CF2E32ECE77725", x => x.NotificationID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Payments__9B556A5808982283", x => x.PaymentID);
                    table.ForeignKey(
                        name: "FK_Payments_SubscriptionPlanID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Comments__C3B4DFAAAB9D27CA", x => x.CommentID);
                    table.ForeignKey(
                        name: "FK_Comments_MovieID",
                        column: x => x.MovieID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__MovieGen__BBEAC46F16BE84B9", x => new { x.MovieID, x.GenreID });
                    table.ForeignKey(
                        name: "FK_MovieGenreMapping_GenreID",
                        column: x => x.GenreID,
                        principalTable: "MovieGenres",
                        principalColumn: "GenreID");
                    table.ForeignKey(
                        name: "FK_MovieGenreMapping_MovieID",
                        column: x => x.MovieID,
                        principalTable: "Movies",
                        principalColumn: "MovieID");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Ratings__FCCDF85C80D7F09B", x => x.RatingID);
                    table.ForeignKey(
                        name: "FK_Ratings_MovieID",
                        column: x => x.MovieID,
                        principalTable: "Movies",
                        principalColumn: "MovieID");
                    table.ForeignKey(
                        name: "FK_Ratings_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__UserFavo__CE74FAF53B3A6860", x => x.FavoriteID);
                    table.ForeignKey(
                        name: "FK_UserFavorites_MovieID",
                        column: x => x.MovieID,
                        principalTable: "Movies",
                        principalColumn: "MovieID");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserID = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    MovieID = table.Column<int>(type: "int", nullable: false),
                    WatchedAt = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "(getdate())"),
                    Progress = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__WatchHis__4D7B4ADDB0BD44E8", x => x.HistoryID);
                    table.ForeignKey(
                        name: "FK_WatchHistory_MovieID",
                        column: x => x.MovieID,
                        principalTable: "Movies",
                        principalColumn: "MovieID");
                    table.ForeignKey(
                        name: "FK_WatchHistory_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Payments__106D3BA810D12558",
                table: "Payments",
                column: "PaymentCode",
                unique: true);
